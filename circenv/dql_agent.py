...
class dql_agent(circenv.mob.mob):
    def __init__(self, x, y, r):
        ...
        self.learner = mdql.munchhausen_dql(input_dim=10, output_dim=6, gamma = 0.999999, epsilon=0.0000001, buffer_size=600000, lr=0.0001, copy_interval=1000, tau=0.4, alpha=0.9)
